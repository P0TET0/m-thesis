...
# s = 3/2 と s = -1/2 の場合の Δ(ξ_F) の計算
big_delta_32 = calculate_big_delta(3/2, xi_F)
big_delta_m12 = calculate_big_delta(-1/2, xi_F)

print("Δ(3/2, ξ_F):", big_delta_32)
print("Δ(-1/2, ξ_F):", big_delta_m12)
