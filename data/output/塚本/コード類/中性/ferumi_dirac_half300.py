...
N_D_values300 = [mpmath.mpf(2.15e25), mpmath.mpf(4.64e25), mpmath.mpf(1e26), mpmath.mpf(2.15e26), mpmath.mpf(4.64e26)]
N_D_values300 = [2.15e25, 4.64e25, 1e26, 2.15e26, 4.64e26]
T_range300 = np.linspace(300,1300,100) # 温度範囲 (300K～1300K)

xi_F_vals300 = [[neutral_xi_F(N_D,T,tol=1e-50) for T in T_range300] for N_D in N_D_values300]

plt.figure(figsize=(10, 6))
for i,N_D in enumerate(N_D_values300):
  plt.plot(T_range300, xi_F_vals300[i], label=f'N_D = {N_D}')
plt.xlabel('T')
plt.ylabel('xi_F')
plt.legend()
plt.show()

with open('xi_F_vals300.pkl', 'wb') as f:
    pickle.dump(xi_F_vals300, f)
with open('N_D_values300.pkl', 'wb') as f:
    pickle.dump(N_D_values300, f)
with open('T_range.pkl300', 'wb') as f:
    pickle.dump(T_range300, f)