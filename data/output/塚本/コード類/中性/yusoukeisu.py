...
# 格子熱伝導率の κ_L 表示
κ_L = lattice_thermal_conductivity(T, Θ, v_s, kb, hbar, β, γ, M_kg, a)
print(f"格子熱伝導率 κ_L:", κ_L, "W/(m·K)")

# s = 3/2、s = -1/2 の場合の電気伝導率 σ 
sigma_32 = calculate_conductivity(3/2, xi_F, xi_g)
sigma_m12 = calculate_conductivity(-1/2, xi_F, xi_g)
print("電気伝導率 σ (s = 3/2):", sigma_32)
print("電気伝導率 σ (s = -1/2):", sigma_m12)

# s = 3/2、s = -1/2 の場合のゼーベック係数 α 
...
# s = 3/2、s = -1/2 の場合の性能指数 ZT
ZT_32 = calculate_ZT(3/2, xi_F, xi_g)
ZT_m12 = calculate_ZT(-1/2, xi_F, xi_g)
print("性能指数 ZT (s = 3/2):", ZT_32)
print("性能指数 ZT (s = -1/2):", ZT_m12)
