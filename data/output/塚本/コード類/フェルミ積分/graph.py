...
plt.ylim(min(conductivity_values_m12 + conductivity_values_32), max(conductivity_values_m12 + conductivity_values_32))  # y軸の範囲を動的に設定
...
plt.legend()
plt.xlim(-5, 5)
plt.ylim(min(seebeck_values_m12 + seebeck_values_32), max(seebeck_values_m12 + seebeck_values_32))
...
plt.legend()
plt.xlim(-5, 5)
plt.ylim(min(lorentz_values_m12 + lorentz_values_32), max(lorentz_values_m12 + lorentz_values_32))
