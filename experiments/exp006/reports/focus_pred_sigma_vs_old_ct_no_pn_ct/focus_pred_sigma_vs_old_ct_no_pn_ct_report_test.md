...
## Ratio Overview
- count: 2618
- min log10(sigma_pred / old C(T)): -0.99594
- median log10(sigma_pred / old C(T)): 0.278337
- max log10(sigma_pred / old C(T)): 2.0162

## Figures
- broad::SnTe_like / sigma_pred_vs_old_ct_no_pn: `experiments\exp006\figures\focus_pred_sigma_vs_old_ct_no_pn_ct\broad_SnTe_like_sigma_pred_points_vs_oldCT_no_pn_line_test.png`
- broad::PbTe_like / sigma_pred_vs_old_ct_no_pn: `experiments\exp006\figures\focus_pred_sigma_vs_old_ct_no_pn_ct\broad_PbTe_like_sigma_pred_points_vs_oldCT_no_pn_line_test.png`
- broad::BiTe_like / sigma_pred_vs_old_ct_no_pn: `experiments\exp006\figures\focus_pred_sigma_vs_old_ct_no_pn_ct\broad_BiTe_like_sigma_pred_points_vs_oldCT_no_pn_line_test.png`
