...
## Figures
- `scatter_all`: `experiments\exp006\figures\focus_sige_like\focus_sige_like_scatter_pred_vs_exp_all.png` / `experiments\exp006\figures\focus_sige_like\focus_sige_like_scatter_pred_vs_exp_all.pdf`
- `scatter_p`: `experiments\exp006\figures\focus_sige_like\focus_sige_like_scatter_pred_vs_exp_p.png` / `experiments\exp006\figures\focus_sige_like\focus_sige_like_scatter_pred_vs_exp_p.pdf`
- `scatter_n`: `experiments\exp006\figures\focus_sige_like\focus_sige_like_scatter_pred_vs_exp_n.png` / `experiments\exp006\figures\focus_sige_like\focus_sige_like_scatter_pred_vs_exp_n.pdf`
- `error_hist_all`: `experiments\exp006\figures\focus_sige_like\focus_sige_like_error_hist_all.png` / `experiments\exp006\figures\focus_sige_like\focus_sige_like_error_hist_all.pdf`
